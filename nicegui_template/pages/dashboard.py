...
TBL_CSS="""<style>.tbl-wrap{max-height:600px;overflow-x:auto;overflow-y:auto;border-radius:8px;border:1px solid #313244;margin-bottom:8px;width:100%;min-width:0}.tbl-wrap table{border-collapse:separate;border-spacing:0;font-size:0.85rem;width:100%;min-width:max-content}.tbl-wrap thead{position:sticky;top:0;z-index:10}.tbl-wrap thead th{background:#1e1e2e;color:#cdd6f4;font-weight:600;padding:12px 14px;border-bottom:2px solid #45475a;white-space:nowrap}.tbl-wrap tbody tr{background:#181825}.tbl-wrap tbody tr:nth-child(even){background:#1e1e2e}.tbl-wrap tbody tr:hover{background:#262637!important}.tbl-wrap tbody td{padding:9px 14px;border-bottom:1px solid #313244;color:#a6adc8;white-space:nowrap}.tbl-wrap tbody td:first-child{color:#cdd6f4;font-weight:600;position:sticky;left:0;z-index:2;background:#181825;min-width:200px}.tbl-wrap tbody tr:nth-child(even) td:first-child{background:#1e1e2e}.tbl-wrap tbody tr:hover td:first-child{background:#262637!important}.tbl-gr{color:#a6e3a1!important;font-weight:600}.tbl-rd{color:#f38ba8!important;font-weight:600}.tbl-gd{color:#f9e2af!important;font-weight:600}.tbl-wrap::-webkit-scrollbar{height:8px;width:8px}.tbl-wrap::-webkit-scrollbar-track{background:#181825;border-radius:4px}.tbl-wrap::-webkit-scrollbar-thumb{background:#45475a;border-radius:4px}.tbl-wrap::-webkit-scrollbar-thumb:hover{background:#585b70}
@media(max-width:768px){
.tbl-wrap{font-size:.75rem;overflow-x:auto!important;max-width:100vw}
.tbl-wrap thead th{padding:8px 8px!important;font-size:.7rem}
.tbl-wrap tbody td{padding:6px 8px!important;font-size:.75rem}
.tbl-wrap tbody td:first-child{min-width:140px!important}
.tbl-wrap tbody td,.tbl-wrap thead th{white-space:nowrap!important}
}</style>"""
